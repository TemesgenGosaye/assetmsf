...
export default function RequesterApplicationStatus() {
  ...
  if (detail) {
    return (
      <div className="mx-auto max-w-3xl space-y-6 pb-10">
        <button
          type="button"
          onClick={() => navigate("/requester/status")}
        ...
        <div className="flex gap-3">
          ...
          <Button variant="outline" onClick={() => navigate("/requester/status")}>Back</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="mx-auto max-w-5xl space-y-6 pb-10">
      ...
      {dash && (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          {[
            ["Total", dash.total, FileText, "text-primary"],
            ...
            <div className="space-y-2">
              {apps.slice(0, 10).map((app) => (
                <div
                  ...
                  onClick={() => navigate(`/requester/status?id=${app.id}`)}
                >
