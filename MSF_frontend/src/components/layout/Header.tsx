      ...
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={cn(
            ...
            "hover:border-[#cc7c5e]/50 hover:bg-[#1a4a2e] hover:text-[#cc7c5e]",
            "focus-visible:outline-none",
            "focus-visible:ring-2",
            "focus-visible:ring-[#cc7c5e]/40"
          )}
        >
          <Bell
            className={cn(
              ...
              "transition-all duration-200",
              unreadCount > 0
                ? "text-[#cc7c5e] group-hover:text-[#e09070]"
                : "text-emerald-100 group-hover:text-[#cc7c5e]"
            )}
            strokeWidth={1.8}
          />
      ...
      {isMobile ? (
        ...
        <div className="relative flex h-full items-center justify-between gap-4 px-4 md:px-6">
          ...
          <Link
            ...
            aria-label="Go to dashboard"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-md border border-[#cc7c5e]/30 bg-[#cc7c5e]/10">
              <Radio className="h-4 w-4 text-[#cc7c5e]" strokeWidth={1.8} />
            </div>
