...
PROPERTIES = [
    ...
    ("Metehara Sugar Factory Plant",              "manufacturing", "Metehara Town, Awash Valley",         "Metahara", "Oromia", "Ethiopia"),
    ("Metehara Cane Plantation Fields",           "other",         "Kessem Estate, Awash Valley",         "Metahara", "Oromia", "Ethiopia"),
    ("Metehara Sugar Factory Administration HQ",  "office",        "Metehara Town, Factory Zone",         "Metahara", "Oromia", "Ethiopia"),
    ("Metehara Sugar Factory Central Store",      "storage",       "Metehara Town, Factory Zone",         "Metahara", "Oromia", "Ethiopia"),
    ("Metehara Sugar Factory Staff Housing",      "other",         "Staff Quarters, Metehara Town",       "Metahara", "Oromia", "Ethiopia"),
]
...
def seed_metehara_factory():
    ...
    # --- Properties ---
    properties = {}
    for name, p_type, address, city, state, country in PROPERTIES:
