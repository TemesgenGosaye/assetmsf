...
urlpatterns = [
    ...
    path(
        "users/<int:user_id>/properties/",
        UserPropertyAccessListView.as_view(),
        name="user_property_access",
    ),
    path(
        "users/<int:user_id>/departments/",
        UserDepartmentAccessListView.as_view(),
